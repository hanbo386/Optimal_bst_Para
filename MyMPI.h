...
void scatter_vector(char *, int **, int *, int *, int *, int *, MPI_Datatype, MPI_Status, MPI_Comm);
...
void read_relicated_vector(char *, void **, MPI_Datatype, int *, MPI_Comm);
